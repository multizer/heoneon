# English Pages - Complete Structure and Content (V2)

## Site Information
- **Site Title**: Informational Structure of Space
- **Description**: Research website for ongoing conceptual project
- **Language**: English
- **Version**: V2 (Updated 2026-01-21)
...
### Section: Hero
**Heading**: A Long-Term Conceptual Research Project on the Structure of Space

**Content**:
This project does not treat space as an empty background or passive container. Instead, it approaches space as something filled with structure—specifically, informational structure—whose organization determines the properties we experience as spatial.

**Status**: Independent research · Conceptual research stage · Ongoing
...
This project is organized around several foundational questions:
...
This project does not present a completed theory. It does not assert new physical laws, nor does it claim to overturn existing scientific frameworks.
...
The project is currently at the conceptual research stage.
...
### Section: Project 01 — Informational Structure of Space

**Status**: Conceptual research · Question formulation stage
...
### Section: Project 02 — Motion as Structural Reconfiguration

**Status**: Early-stage conceptual exploration
...
### Section: Project 03 — Observation, Selection, and Physical Outcomes

**Status**: Conceptual analysis stage
...
### Section: Project 04 — Limits, Structure, and Physical Constraints
...
### Section: Non-Propulsive Motion Reports
...
### Section: Independent Research Context
...
### Section: Independence of the Research
...
## End of English Pages Documentation (V2)

### Changes from V1:
- Updated "Core Questions" section in Home page with revised phrasing
- Updated "Project 04" additional research questions with new terminology
- Updated "Non-Propulsive Motion Reports" section in Examples page
